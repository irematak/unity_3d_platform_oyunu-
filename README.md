...
GameOver() fonksiyonu ile  endPanel gelmektedir ve oyun bitmektedir. endPanel olarak pauseMenusu gelmektedir, bu kısmı ekip arkadaşım bağlamıştır. Oyun bittikten sonra Devam Et butonuna tıklayınca oyun devam etmemektedir. Bu kısım daha geliştirilmemiştir.     
